---
name: rigorous-analysis-opus
description: Rigorous critique of a write-up using Claude Opus (extended thinking). Fetches research from 12 thought-leader sources, mirrors source style, produces full analysis. Invoke with @source-file path. Use when user wants Opus's perspective on a document.
...
Write the critique to a new file: `{source_dir}/analyses/{basename}_analysis_opus.md`
