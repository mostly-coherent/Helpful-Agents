...
| **Hooks** | `.claude/settings.json` → `hooks` section (4 types: command, HTTP, prompt, agent) | `.cursor/hooks.json` (command-based) | **Not portable — different formats, different events** |
