---
name: rigorous-analysis-gemini
description: Rigorous critique of a write-up using Gemini 3.1 Pro (thinking). Fetches research from 12 thought-leader sources, mirrors source style, produces full analysis. Invoke with @source-file path. Use when user wants Gemini's perspective on a document.
...
Write the critique to a new file: `{source_dir}/analyses/{basename}_analysis_gemini.md`
