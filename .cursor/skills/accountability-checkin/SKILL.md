...
description: Acts as an accountability partner. Reads FOCUS.md, runs a structured check-in, and surfaces a single clear next action. Use when user says "check in", "accountability", "what should I do next", "am I on track", "focus check", "what's my priority", or at the start of a work session.
---
